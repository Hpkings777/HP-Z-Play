...
const GameCard: React.FC<GameCardProps> = ({ id, title, category, color, icon, description }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-3xl aspect-[3/4] cursor-pointer isolate shadow-xl ring-1 ring-black/5 dark:ring-white/5 flex flex-col justify-between focus-visible:ring-4 focus-visible:ring-blue-500/50 focus-visible:outline-none"
    >
