      ...
      <div className="absolute inset-0 p-5 flex flex-col justify-between z-20">
        ...
        <div className="flex justify-between items-start">
           ...
           <motion.button
             ...
             className={`p-2.5 rounded-full backdrop-blur-md shadow-sm ring-1 ring-white/10 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 ${
               isFav
