      ...
      <div className="absolute inset-0 p-5 flex flex-col justify-between z-20">
        ...
        <div className="flex justify-between items-start">
           ...
           <motion.button
             ...
             className={`p-2.5 rounded-full backdrop-blur-md shadow-sm ring-1 ring-white/10 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white ${
               isFav
        ...
        <div className="space-y-3 relative">
          ...
          <div className="bg-white/95 dark:bg-[#09090b]/90 backdrop-blur-xl p-4 rounded-2xl border border-white/20 dark:border-white/10 shadow-2xl transform translate-y-2 group-hover:translate-y-0 group-focus-within:translate-y-0 transition-transform duration-400 ease-out will-change-transform">
            ...
            <motion.button
              ...
              className="w-full py-2.5 bg-gray-900 dark:bg-white text-white dark:text-black font-bold rounded-xl flex items-center justify-center gap-2 text-sm shadow-lg shadow-blue-500/10 dark:shadow-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 dark:focus-visible:ring-white"
            >
