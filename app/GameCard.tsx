      ...
      <div className="absolute inset-0 p-5 flex flex-col justify-between z-20">
        ...
        <div className="flex justify-between items-start">
           ...
           <motion.button
             ...
             aria-label={`${isFav ? 'Remove' : 'Add'} ${title} ${isFav ? 'from' : 'to'} favorites`}
             aria-pressed={isFav}
             title={`${isFav ? 'Remove from' : 'Add to'} favorites`}
             className={`p-2.5 rounded-full backdrop-blur-md shadow-sm ring-1 ring-white/10 transition-all duration-300 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none ${
               isFav
